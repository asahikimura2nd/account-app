    ...
    <main>
        ...
        <form action="{{ route('confirm') }}" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input  class="form-control" type="text" name="user_company" id="user_company" placeholder="株式会社〇〇"> 
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input class="form-control" type="text" name="user_name" id="user_name" placeholder="山田　太郎">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">         
                    <input class="form-control" type="text" name="user_tel" id="tel" placeholder="000-0000-0000">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">   
                    <input class="form-control" type="text" name="user_email" id="user_email" placeholder="example@gmail.com">
                </div>
            </div>
            ...
            <div class="mb-5 "></div>         
             ...
             <div class="form-group row">
                ...
                <div class="col-sm-5">
                    <input class="form-control" type="date" name="user_birth_date" id="user_birth_date">
                </div>
            </div>
            ...
            <div class="form-check-inline ">
                <input class="form-check-input " type="radio" name="user_gender" id="user_gender" value="男">
                <label class="form-check-label " for="user_gender">男</label>
            </div>
            <div class="form-check-inline col-sm-2 col-form-label">
                <input class="form-check-input" type="radio" name="user_gender" id="user_gender" value="女">
            ...
            <div class="col-sm-2 col-form-label" ></div>
                <select name="user_job" class="form-group row form-select col-sm-1 col-form-label" aria-label="職業を選択してください" id="user_job" >
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-5"><textarea class="form-control" name="user_content" id="user_content" cols="30" rows="10"></textarea>
                    </div>
                </div>
