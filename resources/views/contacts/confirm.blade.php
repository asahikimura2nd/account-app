...
<body>
    ...
    <main >
        ...
        <div class="mb-5"><h3 class="font-weight-bold text-center">お問い合わせ内容:<br>{{$forms['user_content']}}</h3></div>
       
        <div class="container">
            <div class="row">
                <div class="col text-center">
                    <a href="{{route('send')}}"><button type="button" class="text-center btn btn-success">送信する</button></a>
                    <a href="{{route('form',$forms)}}"><button type="button" class="text-center btn btn-primary">戻る</button></a>
                </div>
            </div>
        </div>
    </main>
